...
import { avalancheFuji, EDUCHAIN_TESTNET, polygonAmoy, sepolia } from "./chains";
...
export const SUPPORTED_TOKENS: SupportedTokens[] = [
  ...
  },
  {
    ...
    tokens: [
      {
        tokenAddress: "0xe7ffE105F7dC49F2ff4412D5c6E8f3C3d1ABc317",
        symbol: "USDC",
        icon: "/erc20-icons/usdc.png",
      },
      {
        tokenAddress: "0xBCe9628e89eC686C9E1878065bec04b45DBD0B40",
        symbol: "USDT",
        icon: "/erc20-icons/usdt.png",
      },
      {
        tokenAddress: "0x8EBaBfE28C6466f67dE8A4d134b5859d2790aF4F",
        symbol: "CAPY",
        icon: "/erc20-icons/usdt.png",
      },
    ],
...
export const NATIVE_TOKEN_ICON_MAP: { [key in Chain["id"]]: string } = {
  ...
  [EDUCHAIN_TESTNET.id]: "/native-token-icons/edu.png",
};
